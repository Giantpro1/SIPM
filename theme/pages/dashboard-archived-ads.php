						...
						<ul class="navbar-nav ml-auto main-nav ">
							...
							<li class="nav-item dropdown dropdown-slide active">
								...
								<ul class="dropdown-menu">
									...
									<li><a class="dropdown-item active" href="dashboard-archived-ads">Dashboard Archived Ads</a></li>
			...
			<div class="col-lg-8">
				...
				<div class="pagination justify-content-center">
					<nav aria-label="Page navigation example">
						<ul class="pagination">
							<li class="page-item">
								<a class="page-link" href="dashboard-archived-ads" aria-label="Previous">
									<span aria-hidden="true">&laquo;</span>
									<span class="sr-only">Previous</span>
								</a>
							</li>
							<li class="page-item"><a class="page-link" href="dashboard-archived-ads">1</a></li>
							<li class="page-item active"><a class="page-link" href="dashboard-archived-ads">2</a></li>
							<li class="page-item"><a class="page-link" href="dashboard-archived-ads">3</a></li>
							<li class="page-item">
								<a class="page-link" href="dashboard-archived-ads" aria-label="Next">
...
<div id="editSimpUser_DisAd" class="modal fade editSimpUSerAd" role="dialog" tabindex="-1" aria-hidden="true">
                                ...
                                <div class="col-lg-6">
                                  ...
                                  <div class="choose-file text-center my-4 py-4 rounded bg-white">
                                    <label for="file-upload">
                                      ...
                                      <input type="file" class="form-control-file d-none" id="file-upload" multiple name="simpUser_AdsImgUpdate[]">
                                    </label>
                                  </div>
                                </div>
                              </div>
...
<script src="../js/disapproveAds.js"></script>
