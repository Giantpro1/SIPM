					...
					<div class="short-popular-category-list text-center">
						...
						<ul class="list-inline">
							<li class="list-inline-item">
								<a href="./pages/category"><i class="fa fa-bed"></i> Hotel</a></li>
							<li class="list-inline-item">
					...
					<div class="col-sm-12 col-lg-4">
						...
						<div class="product-item bg-light">
							<div class="card">
								...
								<div class="card-body">
									<h4 class="card-title"><a href="./pages/single">11inch Macbook Air</a></h4>
									<ul class="list-inline product-meta">
										<li class="list-inline-item">
											<a href="./pages/single"><i class="fa fa-folder-open-o"></i>Electronics</a>
										</li>
										<li class="list-inline-item">
											<a href="./pages/category"><i class="fa fa-calendar"></i>26th December</a>
										</li>
									</ul>
						...
						<div class="product-item bg-light">
							<div class="card">
								...
								<div class="card-body">
									<h4 class="card-title"><a href="./pages/single">Full Study Table Combo</a></h4>
									<ul class="list-inline product-meta">
										<li class="list-inline-item">
											<a href="./pages/single"><i class="fa fa-folder-open-o"></i>Furnitures</a>
										</li>
										<li class="list-inline-item">
											<a href="./pages/category"><i class="fa fa-calendar"></i>26th December</a>
										</li>
					...
					<div class="col-sm-12 col-lg-4">
						...
						<div class="product-item bg-light">
							<div class="card">
								...
								<div class="card-body">
									<h4 class="card-title"><a href="single">Full Study Table Combo</a></h4>
									<ul class="list-inline product-meta">
										<li class="list-inline-item">
											<a href="./pages/single"><i class="fa fa-folder-open-o"></i>Furnitures</a>
										</li>
			...
			<div class="col-md-8">
				<div class="content-holder">
					...
					<ul class="list-inline mt-30">
						<li class="list-inline-item"><a class="btn btn-main" href="./pages/ad-listing">Add Listing</a></li>
						<li class="list-inline-item"><a class="btn btn-secondary" href="./pages/category">Browser Listing</a></li>
					</ul>
				</div>
			</div>
		</div>
