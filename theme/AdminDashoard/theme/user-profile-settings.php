...
<div class="card card-default card-profile">
  ...
  <div class="card-body card-profile-body">
    ...
    <div class="profile-button">
      <a class="btn btn-primary btn-pill" href="user-planing-settings">Upgrade Plan</a>
    </div>
  ...
  <div class="card-footer card-profile-footer">
    <ul class="nav nav-border-top justify-content-center">
      ...
      <li class="nav-item">
        <a class="nav-link" href="user-activities">Activities</a>
      </li>
      <li class="nav-item">
        <a class="nav-link active" href="user-profile-settings">Settings</a>
      </li>
    ...
    <div class="card card-default">
      ...
      <div class="card-body pt-0">
        <ul class="nav nav-settings">
          <li class="nav-item">
            <a class="nav-link active" href="user-profile-settings">
